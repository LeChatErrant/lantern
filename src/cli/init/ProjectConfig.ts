...
export enum ProjectOption {
  ...
  UNIT_TESTS_PIPELINE = 'unit tests pipeline',
  INTEGRATION_TESTS_PIPELINE = 'integration tests pipeline',
...
export const ProjectOptionDefault: ProjectConfig = {
  ...
  [ProjectOption.INTEGRATION_TESTS_PIPELINE]: true,
  [ProjectOption.UNIT_TESTS_PIPELINE]: true,
...
export const ProjectOptionDescriptions: { [key in ProjectOption]: string } = {
  ...
  [ProjectOption.UNIT_TESTS_PIPELINE]: `${blue('Unit tests pipeline')} to test ${green('code logic')}`,
  [ProjectOption.INTEGRATION_TESTS_PIPELINE]: `${blue('Integration tests pipeline')} to test ${green('API endpoints')}`,
